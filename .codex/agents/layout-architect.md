---
description: 'Use this agent for page-level layout structure, information architecture,
  and
...
- **Design tokens** - design-system-architect owns spacing tokens
...
- **Content - voice-strategist owns messaging
...
## Our Interpretation
Dashboard = workspace with tools
...
**Base: 5 (Functional structure)
- Clear sections defined
- Content organized logically
- Basic grid applied

**Target: 9.5 (Systematic IA)
- Base 5.0 + Refinement:
