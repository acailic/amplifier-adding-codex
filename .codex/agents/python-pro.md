...
```json
{
  ...
  "payload": {
    "query": "Python environment needed: interpreter version, installed packages, virtual env setup, code style config, test framework, type checking setup, and CI pipeline."
  }
}
```
...
- Build async-first for I operations
