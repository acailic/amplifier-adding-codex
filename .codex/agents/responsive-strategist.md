---
description: 'Use this agent for responsive design strategy, breakpoint behavior,
  and device-specific
...
1. ✅ **Works Everywhere** - Functions across all devices
...
- **Non-web modalities** - cross-modal-strategist owns voice
...
What's your user's typical device
```
...
- Easy reach: Bottom 1 (primary actions)
- Stretch reach: Middle 1 (secondary actions)
- Hard reach: Top 1 (navigation, status)
```
...
**Common gestures:**
- **Swipe left Navigate between views
- **Swipe down**: Refresh content (pull-to-refresh)
- **Swipe from edge**: Open drawer
...
```javascript
 ...
 Android: Back gesture from left edges
```
